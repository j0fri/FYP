...
int main(int argc, char* argv[]) {
	...
	opts.add_options() 
		...
		("ePertMag", po::value<float>()->default_value(0.2), "Magnitude of perturbation in distribution of electrons.")
		("Nx", po::value<int>()->default_value(30), "Field grid discretization points in x.")
		("Np", po::value<int>()->default_value(50000), "Number of particles.")
		("Lx", po::value<float>()->default_value(4*3.141592), "Field non-dimensional length in x.")
		("Kb", po::value<float>()->default_value(0.000001), "Boltzmann constant.")
		...
		("T", po::value<float>()->default_value(20), "Total time.")
